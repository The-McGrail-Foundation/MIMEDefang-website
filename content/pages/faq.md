...
[What are the prerequisites for installing MIMEDefang?](#1)
...
[What is the architecture of MIMEDefang?](#3)
...
[Why is SpamAssassin not found even though it is installed?](#4)
...
[Why don't SpamAssassin DCC/Razor/RBL checks work?](#5)
...
[When I add a To: header, why doesn't the recipient receive a copy of the e-mail?](#6)
...
[Why won't SpamAssassin tag a message subject?](#7)
...
[Why are my logs filling up with "Milter change: header..." entries?](#8)
...
[What tests is SpamAssassin running? Can I test its configuration?](#9)
...
[How to setup a RAM disk in Linux?](#10)
...
That does *not* mean that Mimedefang administrators are in any way associated with the e-mail. It simply means that your ISP, or the ISP of the sender, is using the [MIMEDefang](https://mimedefang.org) mail scanner to scan for viruses.

[Who altered my e-mail?](#12)

Your system administrator or ISP has installed a scanning program which modified your e-mail.

*Mimedefang administrators are not responsible for things people do with MIMEDefang; if you do not like the way your mail is processed, please do not complain to us. It will do no good.*

[Why was the e-mail altered?](#13)
...
[I didn't send a virus -- why does your software claim I did?](#14)
...
[How is MIMEDefang licensed and what rules must I abide by?](#16)

The [MIMEDefang Project Charter](mimedefang-project-charter.html) proplerly listed out the terms and conditions in which users may interact with the software.

[How does the MIMEDefang Project Operate?](#17)
