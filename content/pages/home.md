Title: Home
Description: MIMEDefang 3.7.1 - open-source email filtering via the Milter API for Sendmail and Postfix. Inspect, modify, or reject mail with custom Perl policies.
